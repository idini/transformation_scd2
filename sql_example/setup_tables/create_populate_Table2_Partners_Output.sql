-- create dataset transformation_scd2 into project worldline-prj
CREATE SCHEMA IF NOT EXISTS `worldline-prj.transformation_scd2`
  OPTIONS (
...
CREATE TABLE IF NOT EXISTS `worldline-prj.transformation_scd2.table_2_partners_output` (
...
INSERT INTO `worldline-prj.transformation_scd2.table_2_partners_output` (TechnicalKey, PartnerID, Name, Canton, Date_From, Date_To, Is_valid) VALUES
